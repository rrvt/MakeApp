...
int DialogDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) {
...
void DialogDlg::DoDataExchange(CDataExchange* pDX) {
...
LRESULT DialogDlg::OnResetToolBar(WPARAM wParam, LPARAM lParam) {setupToolBar();  return 0;}
...
BOOL DialogDlg::OnTtnNeedText(UINT id, NMHDR* pNMHDR, LRESULT* pResult)
...
void DialogDlg::onOption02() {
  statusBar.setText(1, _T("Option 0.2"));
  }


void DialogDlg::onOption11() {
  statusBar.setText(1, _T("Option 1.1"));
  }


void DialogDlg::onOption12() {
...
void DialogDlg::onAppAbout() {AboutDlg aboutDlg; aboutDlg.DoModal();}


void DialogDlg::OnOK() {CDialogEx::OnOK();}
