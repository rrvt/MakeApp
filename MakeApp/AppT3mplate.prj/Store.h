...
// in the data.  Get will return any grouping of data desired from the record, or there might be
// multiple get methods that will retrieve invidual or groups of fields.  Note, the copy
// constructor and operator often call a private function that will do all the copying.
